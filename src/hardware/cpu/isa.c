...
static void TestAddFunctionCallAndComputation() {
    ...
    for (int i = 0; i < 15; i++) {
        cpu_writeinst_dram(va2pa(i * MAX_INSTRUCTION_CHAR * sizeof(char) + 0x00400000), assembly[i]);
    }
    int start = 11;
    cpu_pc.rip = MAX_INSTRUCTION_CHAR * sizeof(char) * start + 0x00400000;
